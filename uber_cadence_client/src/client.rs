...
impl Client for WorkflowClient {
    ...
    async fn list_closed_workflows(
        ...
        let req = ListClosedWorkflowExecutionsRequest {
            ...
            start_time_filter: request.start_time_filter.map(|f| {
                uber_cadence_proto::workflow_service::StartTimeFilter {
            ...
            execution_filter: request.execution_filter.map(|f| {
                uber_cadence_proto::workflow_service::WorkflowExecutionFilter {
                    workflow_id: f.workflow_id,
                }
            }),
            type_filter: request
                .type_filter
                .map(|f| uber_cadence_proto::workflow_service::WorkflowTypeFilter { name: f.name }),
    ...
    async fn count_workflows(
        ...
        let req = uber_cadence_proto::workflow_service::CountWorkflowExecutionsRequest {
            domain: self.domain.clone(),
    ...
    async fn reset_workflow(
        ...
        let req = uber_cadence_proto::workflow_service::ResetWorkflowExecutionRequest {
    ...
    async fn describe_task_list(
        ...
        let request = uber_cadence_proto::workflow_service::DescribeTaskListRequest {
            domain: self.domain.clone(),
            task_list: Some(TaskList {
...
// Helpers
fn convert_retry_policy(policy: RetryPolicy) -> uber_cadence_proto::shared::RetryPolicy {
...
) -> uber_cadence_proto::shared::WorkflowIdReusePolicy {
    match policy {
        WorkflowIdReusePolicy::AllowDuplicateFailedOnly => {
            uber_cadence_proto::shared::WorkflowIdReusePolicy::AllowDuplicateFailedOnly
        }
        WorkflowIdReusePolicy::AllowDuplicate => {
            uber_cadence_proto::shared::WorkflowIdReusePolicy::AllowDuplicate
        }
        WorkflowIdReusePolicy::RejectDuplicate => {
            uber_cadence_proto::shared::WorkflowIdReusePolicy::RejectDuplicate
        }
        WorkflowIdReusePolicy::TerminateIfRunning => {
            uber_cadence_proto::shared::WorkflowIdReusePolicy::TerminateIfRunning
        }
    }
}
...
fn make_proto_execution(
    workflow_id: String,
    run_id: String,
) -> uber_cadence_proto::shared::WorkflowExecution {
    uber_cadence_proto::shared::WorkflowExecution {
        workflow_id,
        run_id,
    }
