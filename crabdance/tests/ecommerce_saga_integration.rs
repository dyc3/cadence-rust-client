...
fn assert_activity_failed(history: &crabdance_proto::shared::History, activity_type: &str) -> bool {
...
fn assert_compensation_executed(history: &crabdance_proto::shared::History) -> bool {
