...
use crabdance_proto::shared::{EventAttributes, EventType, HistoryEvent};
use crabdance_workflow::local_activity::{decode_local_activity_marker, LocalActivityMarkerData};
use crabdance_workflow::side_effect_serialization::{
    decode_mutable_side_effect_details, decode_side_effect_details, decode_version_details,
};
use crabdance_workflow::state_machine::{DecisionId, DecisionsHelper, StateMachineDecisionType};
            ...
            EventType::MarkerRecorded => {
                    ...
                    &event.attributes
                {
                    ...
                    if let Some(details) = &attrs.details {
                        match marker_name {
                            crabdance_workflow::context::SIDE_EFFECT_MARKER_NAME => {
                            ...
                            crabdance_workflow::context::MUTABLE_SIDE_EFFECT_MARKER_NAME => {
                            ...
                            crabdance_workflow::context::VERSION_MARKER_NAME => {
...
mod tests {
        ...
        let marker_event = HistoryEvent {
            ...
            attributes: Some(EventAttributes::MarkerRecordedEventAttributes(Box::new(
                MarkerRecordedEventAttributes {
                    marker_name: crabdance_workflow::context::SIDE_EFFECT_MARKER_NAME.to_string(),
    ...
    fn test_mutable_side_effect_marker() {
        ...
        let marker_event = HistoryEvent {
            ...
            attributes: Some(EventAttributes::MarkerRecordedEventAttributes(Box::new(
                MarkerRecordedEventAttributes {
                    marker_name: crabdance_workflow::context::MUTABLE_SIDE_EFFECT_MARKER_NAME
                        .to_string(),
                    details: Some(details),
                    decision_task_completed_event_id: 59,
                    header: None,
    ...
    fn test_version_marker() {
        ...
        let marker_event = HistoryEvent {
            ...
            attributes: Some(EventAttributes::MarkerRecordedEventAttributes(Box::new(
                MarkerRecordedEventAttributes {
                    marker_name: crabdance_workflow::context::VERSION_MARKER_NAME.to_string(),
                    details: Some(details),
                    decision_task_completed_event_id: 59,
                    header: None,
                },
