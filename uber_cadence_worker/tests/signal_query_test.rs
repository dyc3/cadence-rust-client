...
use uber_cadence_proto::WorkflowQuery;
use uber_cadence_worker::executor::cache::WorkflowCache;
use uber_cadence_worker::executor::workflow::WorkflowExecutor;
...
async fn test_signal_handling() {
    ...
    let executor = WorkflowExecutor::new(
        ...
        uber_cadence_worker::local_activity_queue::LocalActivityQueue::new(),
    );
