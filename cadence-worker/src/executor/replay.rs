...
mod tests {
        ...
        let marker_event = HistoryEvent {
            ...
            attributes: Some(EventAttributes::MarkerRecordedEventAttributes(Box::new(
                MarkerRecordedEventAttributes {
                    marker_name: cadence_workflow::context::SIDE_EFFECT_MARKER_NAME.to_string(),
    ...
    fn test_mutable_side_effect_marker() {
        ...
        let marker_event = HistoryEvent {
            ...
            attributes: Some(EventAttributes::MarkerRecordedEventAttributes(Box::new(
                MarkerRecordedEventAttributes {
                    marker_name: cadence_workflow::context::MUTABLE_SIDE_EFFECT_MARKER_NAME
                        .to_string(),
                    details: Some(details),
                    decision_task_completed_event_id: 59,
                    header: None,
    ...
    fn test_version_marker() {
        ...
        let marker_event = HistoryEvent {
            ...
            attributes: Some(EventAttributes::MarkerRecordedEventAttributes(Box::new(
                MarkerRecordedEventAttributes {
                    marker_name: cadence_workflow::context::VERSION_MARKER_NAME.to_string(),
                    details: Some(details),
                    decision_task_completed_event_id: 59,
                    header: None,
                },
