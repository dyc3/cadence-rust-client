...
| `cadence_activity_task_async_pending_total` | counter | `activity_type` | Activities handed off to async/external completion (so `started ≈ completed + failed + async_pending`) |
