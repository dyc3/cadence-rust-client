...
2. **Added Cadence Client Headers**: Includes `uber_cadence_client-name`, `uber_cadence_client-library-version`, `uber_cadence_client-feature-version`, and `cadence-caller-type`
