...
use crabdance_proto::generated::domain_api_client::DomainApiClient;
use crabdance_proto::generated::visibility_api_client::VisibilityApiClient;
use crabdance_proto::generated::worker_api_client::WorkerApiClient;
use crabdance_proto::generated::workflow_api_client::WorkflowApiClient;
...
fn add_cadence_headers(mut req: tonic::Request<()>) -> Result<tonic::Request<()>, Status> {
    ...
    metadata.insert(
        "crabdance_client-library-version",
        MetadataValue::from_static(LIBRARY_VERSION),
    );
    metadata.insert(
        "crabdance_client-feature-version",
        MetadataValue::from_static(FEATURE_VERSION),
    );
    metadata.insert(
        "crabdance_client-name",
...
impl WorkflowService for GrpcWorkflowServiceClient {
    ...
    async fn start_workflow_execution(
        ...
        let pb_request: crabdance_proto::generated::StartWorkflowExecutionRequest = request.into();
    ...
    async fn signal_workflow_execution(
        ...
        // Convert our API request type to protobuf type
        let pb_request: crabdance_proto::generated::SignalWorkflowExecutionRequest = request.into();
    ...
    async fn signal_with_start_workflow_execution(
        ...
        let pb_request: crabdance_proto::generated::SignalWithStartWorkflowExecutionRequest =
            request.into();
    ...
    async fn request_cancel_workflow_execution(
        ...
        let pb_request: crabdance_proto::generated::RequestCancelWorkflowExecutionRequest =
            request.into();
    ...
    async fn terminate_workflow_execution(
        ...
        let pb_request: crabdance_proto::generated::TerminateWorkflowExecutionRequest =
            request.into();
    ...
    async fn query_workflow(
        ...
        let pb_request: crabdance_proto::generated::QueryWorkflowRequest = request.into();
    ...
    async fn poll_for_decision_task(
        ...
        let pb_request: crabdance_proto::generated::PollForDecisionTaskRequest = request.into();
    ...
    async fn respond_decision_task_completed(
        ...
        let pb_request: crabdance_proto::generated::RespondDecisionTaskCompletedRequest =
            request.into();
    ...
    async fn respond_decision_task_failed(
        ...
        let pb_request: crabdance_proto::generated::RespondDecisionTaskFailedRequest =
            request.into();
    ...
    async fn poll_for_activity_task(
        ...
        let pb_request: crabdance_proto::generated::PollForActivityTaskRequest = request.into();
    ...
    async fn record_activity_task_heartbeat(
        ...
        let pb_request: crabdance_proto::generated::RecordActivityTaskHeartbeatRequest =
            request.into();
    ...
    async fn respond_activity_task_completed(
        ...
        let pb_request: crabdance_proto::generated::RespondActivityTaskCompletedRequest =
            request.into();
    ...
    async fn respond_activity_task_failed(
        ...
        let pb_request: crabdance_proto::generated::RespondActivityTaskFailedRequest =
            request.into();
    ...
    async fn get_workflow_execution_history(
        ...
        let pb_request: crabdance_proto::generated::GetWorkflowExecutionHistoryRequest =
            request.into();
    ...
    async fn describe_workflow_execution(
        ...
        let pb_request: crabdance_proto::generated::DescribeWorkflowExecutionRequest =
            request.into();
    ...
    async fn list_open_workflow_executions(
        ...
        let pb_request: crabdance_proto::generated::ListOpenWorkflowExecutionsRequest =
            request.into();
    ...
    async fn list_closed_workflow_executions(
        ...
        let pb_request: crabdance_proto::generated::ListClosedWorkflowExecutionsRequest =
            request.into();
        let mut client = self.visibility_client.clone();
        let response = client
    ...
    async fn register_domain(&self, request: RegisterDomainRequest) -> Result<(), Self::Error> {
        let pb_request: crabdance_proto::generated::RegisterDomainRequest = request.into();
    ...
    async fn describe_domain(
        ...
        let pb_request: crabdance_proto::generated::DescribeDomainRequest = request.into();
        let mut client = self.domain_client.clone();
        let response = client
    ...
    async fn update_domain(
        ...
        let pb_request: crabdance_proto::generated::UpdateDomainRequest = request.into();
        let mut client = self.domain_client.clone();
        let response = client
    ...
    async fn failover_domain(
        ...
        let pb_request: crabdance_proto::generated::FailoverDomainRequest = request.into();
        let mut client = self.domain_client.clone();
        client
    ...
    async fn respond_activity_task_completed_by_id(
        ...
        let pb_request: crabdance_proto::generated::RespondActivityTaskCompletedByIdRequest =
            request.into();
        let mut client = self.worker_client.clone();
        let response = client
    ...
    async fn respond_activity_task_failed_by_id(
        ...
        let pb_request: crabdance_proto::generated::RespondActivityTaskFailedByIdRequest =
            request.into();
        let mut client = self.worker_client.clone();
        let response = client
    ...
    async fn respond_activity_task_canceled_by_id(
        ...
        let pb_request: crabdance_proto::generated::RespondActivityTaskCanceledByIdRequest =
            request.into();
        let mut client = self.worker_client.clone();
        let response = client
    ...
    async fn record_activity_task_heartbeat_by_id(
        ...
        let pb_request: crabdance_proto::generated::RecordActivityTaskHeartbeatByIdRequest =
            request.into();
        let mut client = self.worker_client.clone();
        let response = client
    ...
    async fn scan_workflow_executions(
        ...
        let pb_request: crabdance_proto::generated::ScanWorkflowExecutionsRequest = request.into();
        let mut client = self.visibility_client.clone();
        let response = client
    ...
    async fn count_workflow_executions(
        ...
        let pb_request: crabdance_proto::generated::CountWorkflowExecutionsRequest = request.into();
        let mut client = self.visibility_client.clone();
        let response = client
    ...
    async fn get_search_attributes(
        ...
        let pb_request: crabdance_proto::generated::GetSearchAttributesRequest = request.into();
        let mut client = self.visibility_client.clone();
        let response = client
    ...
    async fn reset_workflow_execution(
        ...
        let pb_request: crabdance_proto::generated::ResetWorkflowExecutionRequest = request.into();
        let mut client = self.workflow_client.clone();
        let response = client
    ...
    async fn describe_task_list(
        ...
        let pb_request: crabdance_proto::generated::DescribeTaskListRequest = request.into();
        let mut client = self.workflow_client.clone();
        let response = client
    ...
    async fn refresh_workflow_tasks(
        ...
        let pb_request: crabdance_proto::generated::RefreshWorkflowTasksRequest = request.into();
        let mut client = self.workflow_client.clone();
        let response = client
