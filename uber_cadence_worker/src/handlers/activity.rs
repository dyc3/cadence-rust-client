...
impl uber_cadence_activity::ActivityRuntime for ActivityRuntimeImpl {
...
impl ActivityTaskHandler {
    ...
    pub async fn handle(
        ...
        let activity_info = uber_cadence_activity::ActivityInfo {
            activity_id: task.activity_id.clone(),
            activity_type: activity_type.clone(),
            task_token: task.task_token.clone(),
            workflow_execution: uber_cadence_activity::WorkflowExecution {
                workflow_id: task
                    .workflow_execution
                    .as_ref()
        ...
        let context = uber_cadence_activity::ActivityContext::new(activity_info, Some(runtime));
